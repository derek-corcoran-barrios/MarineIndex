...
- http://datos.cedeus.cl/ for gran santiago
...
- **DiversidadAves.R**: bird diversity for each Chilean city with data obtain from iNaturalist using *Poligonos_Ciudades.rds*. We created *Bird_type_prop.rds*.
